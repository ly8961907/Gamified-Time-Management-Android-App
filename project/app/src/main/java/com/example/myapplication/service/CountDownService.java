...
public class CountDownService extends Service {
    ...
    private void sendFinishTimerReceiver() {
        ...
        intent.setAction("com.example.myapplication.service.CountDownService.countFinish");
    ...
    private void sendUptateTimerReceiver(String hour,String minute,String second) {
        ...
        intent.setAction("com.example.myapplication.service.CountDownService.countDown");
        sendBroadcast(intent);
    }
